...
public class FieldConstants {
  ...
  public static final double APRILTAG_WIDTH = Units.inchesToMeters(6.5);
  public static final AprilTagLayoutType DEFAULT_APRILTAG_TYPE = AprilTagLayoutType.OFFICIAL;
  ...
  public static class LinesVertical {
    ...
    public static final double OPP_ALIANCE_ZONE =
