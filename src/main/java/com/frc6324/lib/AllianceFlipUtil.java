...
public class AllianceFlipUtil {
     ...
     * @param x The X coordinate to flip.
     * @return The corresponding X coordinate on the other alliance, unless the current alliance is blue.
     */
     ...
     * @param y The Y coordinate to flip.
     * @return The corresponding Y coordinate on the other alliance, unless the current alliance is blue.
     */
    ...
    public static @NotNull Translation2d applyUnchecked(@NotNull Translation2d translation) {
        return new Translation2d(applyXUnchecked(translation.getX()), applyYUnchecked(translation.getX()));
    }
