...
/**
 * A beam break sensor that uses a Java function to determine the value reported by the "sensor" or
...
public final class BeamBreakIOSupplier implements BeamBreakIO {
  ...
  public void updateInputs(BeamBreakInputs inputs) {
    try {
      ...
      // If the function throws an exception, propogate the exception and mark the sensor as
      // disconnected.
