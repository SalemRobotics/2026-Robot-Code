...
/**
 * Marks a 'static' class in the C# sense - that is, a class that cannot be instantiated. This enforces certain
 ...
 *
 * <p>This annotation <em>cannot</em> ensure that the constructor is reflection attack-resistant; to do so,
